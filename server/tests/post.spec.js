...
describe('GET /api/getPosts', function () {
  ...
  beforeEach('connect and add two post entries', function (done) {
    ...
    connectDB(function () {
      var post1 = new Post({content: "All cats meow 'mern!'"});
      var post2 = new Post({content: "All dogs bark 'mern!'"});
...
describe('GET /api/getPost', function () {
  ...
  beforeEach('connect and add one Post entry', function(done){
    ...
    connectDB(function () {
      var post = new Post({ slug: 'bar', cuid: 'f34gb2bh24b24b2', content: 'Hello Mern says Foo' });
